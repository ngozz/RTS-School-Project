...
public class Map03_EnemySpawner : MonoBehaviour
{
    ...
    private void Update()
    {
        Wave.text = "Wave" + " " + currentWave.ToString() + " / 9";
    ...
    private IEnumerator SpawnWaves()
    {
        ...
        yield return new WaitUntil(() => isEndWave);
        yield return StartCoroutine(SpawnWave9());
    ...
    private void SpawnBoss(int count)
    {
        StartCoroutine(WaitFor(1 * (1f / 3), 3));
    }
